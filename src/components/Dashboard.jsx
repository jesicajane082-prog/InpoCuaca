              ...
              >
                ...
                <div className="px-5 py-2.5 border-t border-slate-100 bg-slate-50/50 flex items-center justify-between">
                  ...
                  <select
                    ...
                    className="bg-transparent text-xs font-semibold text-slate-600 outline-none cursor-pointer hover:text-slate-900 transition-colors border-none py-0.5 pr-2 focus:ring-0 font-medium"
                  >
                    <option value="Qwen/Qwen2.5-72B-Instruct">Qwen 2.5 72B (Cerdas)</option>
                    <option value="deepseek-ai/DeepSeek-R1-Distill-Qwen-32B">DeepSeek R1 (Penalaran)</option>
                    <option value="google/gemma-3-27b-it">Google Gemma 3</option>
                    <option value="meta-llama/Llama-3.3-70B-Instruct">Llama 3.3 (Meta)</option>
                  </select>
                </div>
